  ...
  tryCatch(
    ...
    for (i in 1:nrow(input_csv)) {
      ...
      if (input_csv$ACTIVE[i]=='Y'){
        ...
        print('-----------------------------------------------------------')
        print(glue('Processing {web_layer}'))
        print(glue('Time Start: {time_start}'))
        ...
        time_elapse <- time_delta(time_start, time_end)
        print('')
        print('Processing Complete')
        print(glue('Time Finished: {time_end}'))
        print(glue('Total Elapsed: {time_elapse}'))
        print('-----------------------------------------------------------')
